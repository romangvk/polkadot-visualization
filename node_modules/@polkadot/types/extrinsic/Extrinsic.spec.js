...
describe('Extrinsic', () => {
  describe('V1', () => {
    it('decodes an actual transaction', () => {
      const extrinsic = new _Extrinsic.default(registry, '0x' + '2502' + '81' + 'ff' + 'bfc823aa75c30058eeec21abe2c2d6b7247418a4af89d67a2084c2ac864da080' + 'c0aa4df3b4926c3cd78bbdced31d8bdccb8604b779b71b90e58b2848df4a9ad6' + 'b0aa1aae6be7a05c9413a172b0325e4d214e5ff2b25098028b30f1a50be9c90e' + '0c' + // nonce
      '00' + // era
      '0600' + // balances.transfer
      'ff' + '4a83f1c09be797bc3d9adce29818368b276a84e6b545ced492c25c948978d7f8' + 'e5c0');
  ...
  describe('V2', () => {
    it('decodes an actual transaction', () => {
      const extrinsic = new _Extrinsic.default(registry, '0x' + '2902' + // yes, longer than in v1, 1 byte for the tip
      '82' + 'ff' + 'bfc823aa75c30058eeec21abe2c2d6b7247418a4af89d67a2084c2ac864da080' + 'c0aa4df3b4926c3cd78bbdced31d8bdccb8604b779b71b90e58b2848df4a9ad6' + 'b0aa1aae6be7a05c9413a172b0325e4d214e5ff2b25098028b30f1a50be9c90e' + '00' + // era
      '0c' + // nonce
      '08' + // tip
      '0600' + // balances.transfer
      'ff' + '4a83f1c09be797bc3d9adce29818368b276a84e6b545ced492c25c948978d7f8' + 'e5c0');
    ...
    it('constructs from itself', () => {
      const input = '0x' + '2902' + '82' + 'ff' + 'bfc823aa75c30058eeec21abe2c2d6b7247418a4af89d67a2084c2ac864da080' + 'c0aa4df3b4926c3cd78bbdced31d8bdccb8604b779b71b90e58b2848df4a9ad6' + 'b0aa1aae6be7a05c9413a172b0325e4d214e5ff2b25098028b30f1a50be9c90e' + '00' + // era
      '00' + // nonce
      '00' + // tip
      '0600' + // balances.transfer
      'ff' + '4a83f1c09be797bc3d9adce29818368b276a84e6b545ced492c25c948978d7f8' + 'e5c0';
      expect(new _Extrinsic.default(registry, new _Extrinsic.default(registry, input)).toU8a()).toEqual((0, _util.hexToU8a)(input));
    });
  });
  describe('V4', () => {
    it('decodes an actual transaction', () => {
