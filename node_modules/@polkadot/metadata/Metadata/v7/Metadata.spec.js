...
describe('MetadataV7 (substrate)', () => {
  const registry = new _types.TypeRegistry();
  (0, _testUtil.decodeLatestSubstrate)(registry, 7, _static.default, _staticSubstrate.default);
  (0, _testUtil.toLatest)(registry, 7, _static.default);
