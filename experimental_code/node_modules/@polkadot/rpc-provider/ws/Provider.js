...
class WsProvider {
  ...
  async connect() {
    try {
      ...
      (0, _classPrivateFieldLooseBase2.default)(this, _websocket)[_websocket] = await (0, _getWS.createWS)((0, _classPrivateFieldLooseBase2.default)(this, _endpoints)[_endpoints][(0, _classPrivateFieldLooseBase2.default)(this, _endpointIndex)[_endpointIndex]], (0, _classPrivateFieldLooseBase2.default)(this, _headers)[_headers]);
